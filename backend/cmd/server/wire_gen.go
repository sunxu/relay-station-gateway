...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	directoryHandler, err := directory.ProvideHandler(db, configConfig)
	if err != nil {
		return nil, err
	}
